...
def cadastro(request):
    ...
    messages.success(request, "Registrado com sucesso, utilize o campo abaixo para fazer login!")
...
def dashboard(request):
    ...
    if len(descricao)<5:
        messages.error(request, "Descrição deve ter pelo menos 5 caracteres!")
        form = FormContato(request.POST)
        return render(request, 'accounts/dashboard.html', {'form': form})
